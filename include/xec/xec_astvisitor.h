...
public:
    ...
    return_t visit( xec_new_table* node, arguments_t ... arguments )
        { return ( (visitor_t*)this )->fallback( node, arguments ... ) }
    return_t visit( xec_new_closure* node, arguments_t ... arguments )
        { return ( (visitor_t*)this )->fallback( node, arguments ... ) }
...
template < typename visitor_t, typename return_t, typename ... arguments_t >
return_t xec_astvisitor::visit( xec_ast_node* node, arguments_t ... arguments )
{
    typedef return_t (xec_astvisitor::*visit_t)(
    ...
    static visit_t dispatch[] =
    {
        ...
        &visitor_t::template dispatch< xec_new_closure >,
...
template < typename visitor_t, typename return_t, typename ... arguments_t >
template < typename node_t >
return_t xec_astvisitor< visitor_t, return_t, arguments_t ... >::dispatch(
