...
public:
    ...
    explicit yl_parser( yl_diagnostics* diagnostics );
    ~yl_parser();
...
// lemon private:
    ...
    yl_diagnostics*     get_diagnostics();
    ...
    yl_ast_scope*       switch_scope( yl_ast_node* node );
    void                close_switch( yl_ast_scope* switch_scope );
