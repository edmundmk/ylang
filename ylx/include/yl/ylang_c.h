...
enum yl_call_result
{
    YL_CALL_RETURN,     // call completed, cothread returned.
    YL_CALL_YIELD,      // cothread has yielded.
    YL_CALL_THROW,      // exception was thrown.
};
...
yl_value yl_cothread_create();
bool yl_cothread_begin( yl_value cothread, yl_value function );
yl_value yl_cothread_resume( yl_value cothread, yl_value* arguments, size_t argcount );
yl_value_unpack yl_cothread_resume_unpack( yl_value cothread, yl_value* arguments, size_t argcount );
...
yl_value yl_native_object_create( yl_value prototype, void* data );
void* yl_native_object_get( yl_value native );
void yl_native_object_set( yl_value native, void* data );
...
// TODO.  Also need to get unwind information.
